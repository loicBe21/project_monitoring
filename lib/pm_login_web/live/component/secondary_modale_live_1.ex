defmodule PmLoginWeb.LiveComponent.SecondaryModalLive1 do
                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="column">
                      ...
                      <%= if @is_admin == true do %>
                       <label class="zoom-out">Assigner intervenant</label>
                        <%= select f, :contributor_id, @list_admins ++ @attributors ++ @contributors, style: "width: -webkit-fill-available; width: -moz-available; height: 38px;"%>
                      <% end %>
                  ...
                  <div class="row">
                    <div class="column">
                      ...
                      <p><%= @parent_task.title %></p>
                      <div class="text-wrap">
                        <%= hidden_input f, :parent_id, value: @parent_task.id, style: "width: -webkit-fill-available; width: -moz-available; height: 38px;"%>
                      </div>
                      <div class="zoom-out">
